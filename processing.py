...
def doPredicts(data, path, title=None):
    ...
    col_check = ["Вежливость","Технические проблемы","Оскорбления и конфликты","Реклама и спам","Плохое объяснение материала","Хорошее объяснение материала","Помощь и понимание","Опоздание"]
    groupefewfs = [ "Вежливость", "Технические проблемы", "Хорошее объяснение материала", "Плохое объяснение материала", "Помощь и понимание", "Реклама и спам", "Оскорбления и конфликты", "Опоздание", "Выполнение задания"]
    ...
    if row["Плохое объяснение материала"]/count > 0.2:
